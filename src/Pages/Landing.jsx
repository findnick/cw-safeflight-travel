import headerImage from "../assets/img/landing-header-image.jpg";
import Curve from "../assets/img/landingCurve.svg";
...
import abs1 from "../assets/img/abs-img-1.png";
import abs2 from "../assets/img/abs-img-2.png";
    ...
    <>
      ...
      <div className="header mx-auto">
        <div className="flex flex-col" style={{ background: "var(--white)" }}>
          ...
          >
            <h1
              className="text-center pt-32 p-2 mx-auto w-4/5 text-7xl font-bold"
          ...
          {/* Index Section 4 */}
          <IndexSection
            sectionClass="flex-row gap-8 pb-10"
            headingClass={"text-left w-1/2"}
            miniHeading="PROIN BLANDIT"
            mainHeading="Lorem ipsum dolor sit amet consectetur."
            button={true}
            buttonStyle={{
            ...
            para="Lorem ipsum dolor sit amet consectetur. Scelerisque tellus elementum lorem neque volutpat amet. Justo et id urna ornare dignissim dictumst. Lectus eu morbi vitae dolor scelerisque mattis. Facilisis arcu aenean maecenas lectus lectus.Lorem ipsum dolor sit amet consectetur. Arcu integer vivamus enim phasellus duis sit. At pellentesque ultrices aenean gravida lorem. Non id id turpis habitant nunc ac phasellus et risus."
            containerClass="flex flex-row flex-shrink flex-wrap self-start items-center justify-center mx-auto gap-6 w-1/2 mt-0"
            containerStyle={{ height: "30rem" }}
          >
            <div
              className="h-2/3 w-48 p-2"
            ...
            <div
              className="self-start p-2 h-2/3 w-48"
              style={{ boxShadow: "0px 0px 4px 4px #d5d5d5", borderRadius: 9 }}
            >
              <img
                src={sec4_2}
          ...
          <IndexSection
            ...
            button={true}
            buttonText="Get Started"
            buttonDivClass="w-full py-10 bg-white flex items-center justify-center"
