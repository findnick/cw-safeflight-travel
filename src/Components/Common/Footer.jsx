    ...
    <div className="footer py-10 px-16">
      <div className="footer-section-1 flex flex-col md:flex-row">
        <div className="footer-box md:w-5/12 flex flex-col gap-4">
          ...
          <div className="footer-social flex flex-row gap-6">
        ...
        <div className="footer-box md:w-7/12 md:pl-12 flex flex-col justify-around pt-6">
          ...
          <div className="footer-support-links flex flex-row font-normal text-xl gap-12">
      ...
      <div className="footer-section-2 flex flex-row justify-between">
        <div className="footer-copyright">&copy; 2022 SafeFlight, Inc.</div>
        <div className="footer-links flex flex-row gap-6">
